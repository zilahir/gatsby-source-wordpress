...
function () {
  var _ref = (0, _asyncToGenerator2.default)(function* ({
    ...
    entities = normalize.createGatsbyIds(createNodeId, entities); // Creates links between authors and user entities
    ...
    entities = normalize.mapPolylangTranslations(entities); // apply custom normalizer
